...
2.  LISTS <br>
    ...
    `ls.emplace_front(2)` : insert element at the front.<br>
...
3.  DEQUE <br>
    ...
    rest functions same as vectors :
    `push_back(), push_front(), emplace_back(), emplace_front(), begin(), end(), erase(), size(), clear(), empty(), swap(), rbegin(), rend() ` <br>
...
6.  PRIORITY QUEUE <br>
    ...
    Syntax: `priority_queue<int, vector<int>, greater<int>> pq2;`

    Functions : `push(), pop(), size(), empty(), swap()`
